...
class CustomerLevelAppointmentDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ['blue', 'آوا', 'کاظمی', 'زن', '09:00', 2500000, 'پاکسازی پوست', 'اینستاگرام', 'اولین مراجعه؛ مشاوره و پاکسازی پوست'],
            ['blue', 'سامیار', 'نیک‌روش', 'مرد', '09:30', 4250000, 'مزوتراپی مو', 'معرفی دوستان', 'اولین مراجعه؛ ارزیابی و مزوتراپی مو'],
            ['blue', 'هلیا', 'پارسا', 'زن', '10:00', 6750000, 'فیشیال تخصصی', 'وب‌سایت', 'اولین مراجعه؛ فیشیال و آبرسانی تخصصی'],
            ['silver', 'نیلوفر', 'رحیمی', 'زن', '10:30', 10000000, 'میکرونیدلینگ', 'اینستاگرام', 'مشتری نقره‌ای؛ جلسه میکرونیدلینگ صورت'],
            ['silver', 'آرین', 'فرهمند', 'مرد', '11:00', 12500000, 'لیزر جوان‌سازی', 'گوگل', 'مشتری نقره‌ای؛ پکیج جوان‌سازی پوست'],
            ['silver', 'ترانه', 'شریفی', 'زن', '11:30', 20000000, 'ژل لب', 'مراجعه حضوری', 'مشتری نقره‌ای؛ تزریق ژل با فرم طبیعی'],
        ...
        foreach ($rows as $index => [$level, $firstName, $lastName, $gender, $time, $amount, $service, $source, $description]) {
            ...
            Patient::updateOrCreate(
                ...
                [
                    ...
                    'financial_status' => $level === 'gold' ? 'عالی' : ($level === 'silver' ? 'خوب' : 'متوسط'),
